...
import ATSSimulatorPage from '../app/ats-simulator/page';
import CallAnalyzerPage from '../app/call-analyzer/page';
import InterviewPrepPage from '../app/interview-prep/page';
import SkillGapMapPage from '../app/skill-gap/page';
...
export const RouteHandler: React.FC = () => {
  ...
  return useMemo(() => {
    ...
    switch (normalizedPath) {
      ...
      case 'ats-simulator': return <ATSSimulatorPage />;
      case 'call-analyzer': return <CallAnalyzerPage />;
      case 'interview-prep': return <InterviewPrepPage />;
      case 'skill-gap': return <SkillGapMapPage />;
